...
const char * const BITCOIN_CONF_FILENAME = "eledger.conf";
const char * const BITCOIN_PID_FILENAME = "eledgerd.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\eledger
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\eledger
    // Mac: ~/Library/Application Support/eledger
    // Unix: ~/.eledger
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "eledger";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/eledger";
#else
    // Unix
    return pathRet / ".eledger";
#endif
#endif
}
...
boost::filesystem::path GetEnodeConfigFile()
{
