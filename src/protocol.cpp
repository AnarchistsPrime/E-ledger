...
//znode
    ...
    const char *ENODEPAYMENTVOTE = "mnw";
    const char *ENODEPAYMENTBLOCK = "mnwb";
    const char *ENODEPAYMENTSYNC = "mnget";
...
const static std::string allNetMessageTypes[] = {
        ...
        NetMsgType::ENODEPAYMENTVOTE,
        NetMsgType::ENODEPAYMENTBLOCK,
        NetMsgType::ENODEPAYMENTSYNC,
        NetMsgType::SPORK,
...
const char* CInv::GetCommand() const
{
    ...
    switch (type)
    {
        ...
        case MSG_ENODE_PAYMENT_VOTE:    return NetMsgType::ENODEPAYMENTVOTE;
        case MSG_ENODE_PAYMENT_BLOCK:   return NetMsgType::ENODEPAYMENTBLOCK;
        case MSG_ENODE_ANNOUNCE:        return NetMsgType::MNANNOUNCE;
        case MSG_ENODE_PING:            return NetMsgType::MNPING;
        case MSG_DSTX:                  return NetMsgType::DSTX;
        case MSG_ENODE_VERIFY:          return NetMsgType::MNVERIFY;
        default: {
            return "error";
        }
    }
