...
CDarkSendRelay::CDarkSendRelay(CTxIn& vinEnodeIn, vector<unsigned char>& vchSigIn, int nBlockHeightIn, int nRelayTypeIn, CTxIn& in2, CTxOut& out2)
{
    vinEnode = vinEnodeIn;
    vchSig = vchSigIn;
...
{
    CEnode* pmn = mnodeman.GetEnodeByRank(nRank, nBlockHeight, MIN_PRIVATESEND_PEER_PROTO_VERSION);
