...
static const int HF_ENODE_HEIGHT = 103;
static const int HF_ENODE_PAYMENT_START = HF_ENODE_HEIGHT + 150; // 66700 - about 25h after HF
...
static const int HF_ENODE_HEIGHT_TESTNET = 500;
