...
BOOST_AUTO_TEST_CASE(doubles_conversion)
{
    ...
    BOOST_CHECK_EQUAL(ser_uint64_to_double(0x4081948880000000ULL), 785.066650390625);
    ...
    BOOST_CHECK_EQUAL(ser_double_to_uint64(785.066650390625), 0x4081948880000000ULL);
}
/*
