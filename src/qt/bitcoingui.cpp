...
void BitcoinGUI::createActions()
{
	...
	sendCoinsAction->setStatusTip(tr("Send coins to a Eledger address"));
	...
	receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and eledger: URIs)"));
    ...
    znodeAction = new QAction(platformStyle->SingleColorIcon(":/icons/znodes"), tr("&Enodes"), this);
    znodeAction->setStatusTip(tr("Browse Enodes"));
    ...
    connect(znodeAction, SIGNAL(triggered()), this, SLOT(gotoEnodePage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Eledger addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Eledger addresses"));
    ...
    openAction->setStatusTip(tr("Open a eledger: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Eledger command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::gotoEnodePage()
{
    QSettings settings;
    znodeAction->setChecked(true);
    if (walletFrame) walletFrame->gotoEnodePage();
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Eledger network", "", count));
}
...
{
    QString strTitle = tr("Eledger"); // default title
