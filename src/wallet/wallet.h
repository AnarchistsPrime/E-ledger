...
public:
    ...
    // znode
    /// Get 1000 P2P output and keys which can be used for the Enode
    bool GetEnodeVinAndKeys(CTxIn& txinRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash = "", std::string strOutputIndex = "");
